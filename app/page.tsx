...
export default function Home() { return <>
  ...
  <main id="main-content">
    <section className="hero" id="top"><div className="container hero-grid"><div><p className="eyebrow">VooStream IPTV · Est. 2026</p><h1>All your screens.<br/><em>One clear course.</em></h1><p className="hero-lead">Live TV, sports, movies and series through one IPTV subscription. Choose your term, contact the crew and receive your login details.</p><div className="hero-actions"><a className="button button-primary" href="#pricing">View IPTV plans</a><a className="button button-ghost" href={contact.whatsapp} target="_blank" rel="noopener nofollow">Message on WhatsApp</a></div></div><aside className="hero-log" aria-label="Service summary"><p>CAPTAIN&apos;S LOG / SERVICE 01</p><dl><div><dt>Channels</dt><dd>11,000+</dd></div><div><dt>Quality</dt><dd>4K · FHD · HD</dd></div><div><dt>Access</dt><dd>Xtream + M3U</dd></div><div><dt>Support</dt><dd>Direct contact</dd></div></dl><span>VOOSTREAM / IPTV</span></aside></div></section>
    ...
    <section className="section faq-section" id="faq"><div className="container faq-grid"><div><p className="kicker">Ship&apos;s notes</p><h2>Questions before you subscribe</h2><p>Need a direct answer? Contact the VooStream team through WhatsApp, Telegram or email.</p></div><Faq /></div></section>
